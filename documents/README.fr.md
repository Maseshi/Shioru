...
- Accédez au terminal et exécutez les commandes `npm run dev` pour le développement et `npm start` pour la production > **Note**: En mode développement Certaines fonctionnalités peuvent ne pas fonctionner.
