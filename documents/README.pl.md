...
- Przejdź do terminala i uruchom polecenia `npm run dev` dla programowania i `npm start` dla produkcji > **Uwaga**: W trybie programowania Niektóre funkcje mogą nie działać.
