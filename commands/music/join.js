module.exports.run = async function (client, message, args) {
	...
	if (!arg) {
		...
		if (!voiceChannel) return message.reply(client.lang.command_music_join_user_not_join_channel);
		...
		if (!channel) return message.reply(client.lang.command_music_join_with_id_not_found_channel);
