...
module.exports.run = async function (client, message, args) {
	...
	if (args[0]) {
		...
		if (!cmd) return message.reply(info.setTitle(client.lang.command_information_help_if_dont_have_cmd_embed_edit_title).setDescription(client.lang.command_information_help_if_dont_have_cmd_embed_edit_description.replace("%prefix", client.config.prefix)));
