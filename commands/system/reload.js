...
module.exports.run = (client, message, args) => {
    let arg = args[0];
    if (!arg) return message.reply(client.lang.command_system_reload_arg_empty);
    ...
    if (!command) return message.reply(client.lang.command_system_reload_command_not_found);
