module.exports.run = async function (client, message, args) {
	if (message.guild.id === "618837514882514944") {
		...
		let embed = {
			...
			"author": {
				"name": "Shioru",
				"url": "https://discordapp.com/users/693826052447010857",
				"icon_url": "https://cdn.discordapp.com/avatars/658522051790897198/33a8ce32cb462cda55cc620d0101db1c.webp"
			},
			"fields": [
				{
