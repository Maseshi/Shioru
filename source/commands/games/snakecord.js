...
module.exports.command = {
    "enable": true,
    "usage": "snakecord",
    "aliases": ["เกมงู", "snakegame", "snake"],
    async execute(client, message, args) {
        // Original source code from:
        // https://github.com/Terra-rian/snakecord
        ...
        const step = () => {
            ...
            const editEmbed = new EmbedBuilder()
                .setTimestamp()
                .setColor("Green")
                .setTitle(client.translate.commands.snakecord.game_name)
                .setDescription(gameBoardToString())
                .setFooter({ "iconURL": authorAvatar, "text": client.translate.commands.snakecord.played_on.replace("%s", authorUsername) });
        ...
        const gameOver = () => {
            ...
            const editEmbed = new EmbedBuilder()
                .setTimestamp()
                .setColor("Blue")
                .setTitle(client.translate.commands.snakecord.game_over)
                .setDescription(client.translate.commands.snakecord.game_score.replace("%s1", score).replace("%s2", Math.floor(playTime / 1000)))
                .setFooter({ "iconURL": authorAvatar, "text": client.translate.commands.snakecord.played_on.replace("%s", authorUsername) });
        ...
        snake = [{ "x": 5, "y": 5 }];
        newAppleLocation();
        const oldMessage = await message.channel.send(client.translate.commands.snakecord.building_board_game);
        const authorAvatar = message.author.displayAvatarURL();
        const authorUsername = message.author.username;
    ...
    async execute(interaction) {
        ...
        const step = () => {
            ...
            const editEmbed = new EmbedBuilder()
                .setTimestamp()
                .setColor("Green")
                .setTitle(interaction.client.translate.commands.snakecord.game_name)
                .setDescription(gameBoardToString())
                .setFooter({ "iconURL": authorAvatar, "text": interaction.client.translate.commands.snakecord.played_on.replace("%s", authorUsername) });
        ...
        const gameOver = () => {
            ...
            const editEmbed = new EmbedBuilder()
                .setTimestamp()
                .setColor("Blue")
                .setTitle(interaction.client.translate.commands.snakecord.game_over)
                .setDescription(interaction.client.translate.commands.snakecord.game_score.replace("%s1", score).replace("%s2", Math.floor(playTime / 1000)))
                .setFooter({ "iconURL": authorAvatar, "text": interaction.client.translate.commands.snakecord.played_on.replace("%s", authorUsername) });
        ...
        await interaction.editReply(interaction.client.translate.commands.snakecord.building_board_game);
