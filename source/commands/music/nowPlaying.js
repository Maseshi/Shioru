...
module.exports.interaction = {
    ...
    async execute(interaction) {
        ...
        const musicFilter = queue.filter !== "clear" ? "\n" + interaction.client.translate.commands.nowPlaying.filter.replace("%s", queue.filter) : "";
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "iconURL": avatarURL,
                        "text": interaction.client.translate.commands.nowPlaying.owner_this_queue.replace("%s", queueAuthorUsername)
                    }
                }
            ]
        });
